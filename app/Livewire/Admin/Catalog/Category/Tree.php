...
class Tree extends Component
{
    ...
    public string $scope = Category::SCOPE_BLOG;
    ...
    protected $queryString = [
        'search' => ['except' => ''],
        'scope' => ['except' => Category::SCOPE_BLOG],
        'locale' => ['except' => 'en'],
    ];
    ...
    public function mount(): void
    {
        ...
        if (in_array($requestedScope, $this->scopeOptions, true)) {
    ...
    {
        if (!in_array($this->scope, $this->scopeOptions, true)) {
            $this->scope = Category::SCOPE_BLOG;
        }
    ...
    public function getScopeOptionsProperty(): array
    {
        return array_values(array_filter(
            Category::availableScopes(),
            static fn (string $scope): bool => $scope !== Category::SCOPE_CATALOG
        ));
    }
