...
class CollaborationAssessmentMessageManager extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.message.collaboration-assessment-message-manager', [
            'rows' => $rows,
            'perPage' => $perPage,
    ...
    private function updateStatus(int $messageId, string $status): void
    {
        ...
        if (! $message) {
            $this->dispatch('notify', type: 'danger', message: __('admin.messages.collaboration_assessment.manager.notify_not_found'));
    ...
    private function statusOptions(): array
    {
        return [
            ...
            ContactMessage::STATUS_NEW => __('admin.messages.collaboration_assessment.status.new'),
            ContactMessage::STATUS_READ => __('admin.messages.collaboration_assessment.status.read'),
            ContactMessage::STATUS_RESOLVED => __('admin.messages.collaboration_assessment.status.resolved'),
        ];
    }
}
