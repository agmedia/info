...
class EuFundsQuestionnaireManager extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.message.eu-funds-questionnaire-manager', [
            'rows' => $rows,
            'perPage' => $perPage,
    ...
    private function updateStatus(int $messageId, string $status): void
    {
        ...
        if (! $message) {
            $this->dispatch('notify', type: 'danger', message: __('admin.messages.eu_funds_questionnaire.manager.notify_not_found'));
    ...
    private function statusOptions(): array
    {
        return [
            ...
            ContactMessage::STATUS_NEW => __('admin.messages.eu_funds_questionnaire.status.new'),
            ContactMessage::STATUS_READ => __('admin.messages.eu_funds_questionnaire.status.read'),
            ContactMessage::STATUS_RESOLVED => __('admin.messages.eu_funds_questionnaire.status.resolved'),
        ];
    }
}
