...
class AuditServicePageDefaults
{
    ...
    private static function croatianDefaults(): array
    {
        return [
            ...
            'overview' => [
                'kicker' => 'REVIZIJA',
                'title' => 'Zašto Vam je revizija bitna?',
                'intro' => '',
                'highlight_title' => 'Zašto Vam je revizija bitna?',
                'body' => [
    ...
    private static function englishDefaults(): array
    {
        return [
            ...
            'overview' => [
                'kicker' => 'AUDIT',
                'title' => 'Why does audit matter to you?',
                'intro' => '',
                'highlight_title' => 'Why does audit matter to you?',
                'body' => [
