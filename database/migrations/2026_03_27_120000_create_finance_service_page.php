...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $templateKey = ServicePageTemplateRegistry::FINANCE;
        ...
        $translations = [
            'hr' => [
                'title' => 'Financije',
                'slug' => 'financije',
                'meta_title' => 'Financije',
                'meta_description' => 'Financijsko savjetovanje za M&A, due diligence, procjene vrijednosti, pribavljanje kapitala i restrukturiranje.',
            ],
            'en' => [
                'title' => 'Finance',
                'slug' => 'finance',
                'meta_title' => 'Finance',
                'meta_description' => 'Financial advisory for M&A, due diligence, valuations, capital raising, and restructuring.',
            ],
        ];
