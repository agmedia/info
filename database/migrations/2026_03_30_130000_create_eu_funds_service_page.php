    ...
    public function up(): void
    {
        ...
        $translations = [
            'hr' => [
                ...
                'meta_description' => 'EU fondovi, natjecaji, HBOR i HAMAG instrumenti te poticaji za ulaganja na jednom mjestu.',
            ],
            'en' => [
                'title' => 'EU Funds',
                'slug' => 'eu-funds',
                'meta_title' => 'EU Funds',
                'meta_description' => 'EU funds, funding calls, investment incentives, and financing instruments in one place.',
            ],
        ];
