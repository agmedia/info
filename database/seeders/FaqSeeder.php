    ...
    public function run(): void
    {
        ...
        $records = [
            ...
            [
                ...
                'translations' => [
                    'en' => [
                        'question' => 'Can I request a content update after publishing?',
                        'slug' => 'can-i-request-content-update-after-publishing',
                        'answer_html' => '<p>Yes. Send the page URL and requested changes, and support will guide the next revision step.</p>',
                    ],
                    'hr' => [
                        'question' => 'Mogu li zatraziti izmjenu sadrzaja nakon objave?',
                        'slug' => 'mogu-li-zatraziti-izmjenu-sadrzaja-nakon-objave',
                        'answer_html' => '<p>Da. Posaljite URL stranice i trazene izmjene, a podrska ce voditi sljedeci korak revizije.</p>',
                    ],
                ],
            ],
        ];
