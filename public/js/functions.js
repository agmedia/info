...
/***/ "./resources/sass/canvas/js/functions.bundle.js":
/*!******************************************************!*\
  !*** ./resources/sass/canvas/js/functions.bundle.js ***!
  \******************************************************/
...
(function (global, factory) {
  ...
  var Core = function () {
    return {
      ...
      topScrollOffset: function topScrollOffset() {
        var _vars$elPageMenu, _vars$elPageMenu$quer;
        var topOffsetScroll = 0;
        var pageMenuOffset = ((_vars$elPageMenu = vars.elPageMenu) === null || _vars$elPageMenu === void 0 ? void 0 : (_vars$elPageMenu$quer = _vars$elPageMenu.querySelector('#page-menu-wrap')) === null || _vars$elPageMenu$quer === void 0 ? void 0 : _vars$elPageMenu$quer.offsetHeight) || 0;
        if (vars.elBody.classList.contains('is-expanded-menu')) {
          var _vars$elHeader, _vars$elPageMenu2;
          ...
          if ((_vars$elPageMenu2 = vars.elPageMenu) !== null && _vars$elPageMenu2 !== void 0 && _vars$elPageMenu2.classList.contains('dots-menu')) {
            pageMenuOffset = 0;
          }
        }
    ...
    return {
      ...
      setBSTheme: function setBSTheme() {
        ...
        if (vars.elBody.classList.contains('dark')) {
          ...
          (_document$querySelect = document.querySelectorAll('.dark')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.forEach(function (el) {
            el.setAttribute('data-bs-theme', 'dark');
          });
        }
        (_vars$elBody$querySel = vars.elBody.querySelectorAll('.not-dark')) === null || _vars$elBody$querySel === void 0 ? void 0 : _vars$elBody$querySel.forEach(function (el) {
  ...
  var Modules = function () {
    return {
      ...
      ajaxButton: function ajaxButton(element) {
...
(function (global, factory) {
  ...
  return {
    ...
    GoToTop: function () {
      ...
      var _scroll = function _scroll(element) {
    ...
    Headers: function () {
      var _offset = function _offset() {
        var _core$getVars$elHead, _core$getVars$elHead2, _core$getVars$elHead3, _core$getVars$elHead4;
        var elHeader = __core.getVars.elHeader;
        var elHeaderInc = document.querySelector('.include-header');
        __core.getVars.headerOffset = elHeader.offsetTop;
        if ((_core$getVars$elHead = __core.getVars.elHeader) !== null && _core$getVars$elHead !== void 0 && _core$getVars$elHead.classList.contains('floating-header') || elHeaderInc !== null && elHeaderInc !== void 0 && elHeaderInc.classList.contains('include-topbar')) {
          __core.getVars.headerOffset = __core.offset(elHeader).top;
        }
        (_core$getVars$elHead2 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead2 === void 0 ? void 0 : _core$getVars$elHead2.classList.add('position-absolute');
        __core.getVars.headerWrapOffset = __core.getVars.headerOffset + ((_core$getVars$elHead3 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead3 === void 0 ? void 0 : _core$getVars$elHead3.offsetTop);
        (_core$getVars$elHead4 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead4 === void 0 ? void 0 : _core$getVars$elHead4.classList.remove('position-absolute');
      ...
      var _sticky = function _sticky(stickyOffset) {
      ...
      var _removeSticky = function _removeSticky() {
        var _core$getVars$elHead5;
        ...
        if (!((_core$getVars$elHead5 = __core.getVars.elHeaderWrap) !== null && _core$getVars$elHead5 !== void 0 && _core$getVars$elHead5.classList.contains('force-not-dark'))) {
          var _core$getVars$elHead6;
          (_core$getVars$elHead6 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead6 === void 0 ? void 0 : _core$getVars$elHead6.classList.remove('not-dark');
        }
        __base.sliderMenuClass();
      };
      var _changeMenuClass = function _changeMenuClass(type) {
        var newClassesArray = '';
        if ('responsive' == type) {
        ...
        if (noOfNewClasses > 0) {
          ...
          for (i = 0; i < noOfNewClasses; i++) {
            if (newClassesArray[i] == 'not-dark') {
              var _core$getVars$elHead7;
              __core.getVars.elHeader.classList.remove('dark');
              if (!((_core$getVars$elHead7 = __core.getVars.elHeaderWrap) !== null && _core$getVars$elHead7 !== void 0 && _core$getVars$elHead7.classList.contains('.not-dark'))) {
                var _core$getVars$elHead8;
                (_core$getVars$elHead8 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead8 === void 0 ? void 0 : _core$getVars$elHead8.classList.add('not-dark');
              }
            } else if (newClassesArray[i] == 'dark') {
              var _core$getVars$elHead9;
              (_core$getVars$elHead9 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead9 === void 0 ? void 0 : _core$getVars$elHead9.classList.remove('not-dark force-not-dark');
      ...
      var _includeHeader = function _includeHeader() {
        var elHeaderInc = document.querySelector('.include-header');
        var elHeader = __core.getVars.elHeader;
      ...
      var _sideHeader = function _sideHeader() {
      ...
      return {
        init: function init(selector) {
          ...
          __core.getVars.headerHeight = elHeader.offsetHeight;
          if (!headerWrapClone) {
            var _core$getVars$elHead10, _core$getVars$elHead11;
            headerWrapClone = document.createElement('div');
            headerWrapClone.classList = 'header-wrap-clone';
            (_core$getVars$elHead10 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead10 === void 0 ? void 0 : _core$getVars$elHead10.parentNode.insertBefore(headerWrapClone, (_core$getVars$elHead11 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead11 === void 0 ? void 0 : _core$getVars$elHead11.nextSibling);
    ...
    Menus: function () {
      var _init = function _init() {
        var _core$getVars$elHead12;
        __core.getVars.headerWrapHeight = (_core$getVars$elHead12 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead12 === void 0 ? void 0 : _core$getVars$elHead12.offsetHeight;
        ...
        document.addEventListener('click', function (e) {
          ...
          if (!e.target.closest('.primary-menu.on-click')) {
            ...
            onClickMenuCurrent === null || onClickMenuCurrent === void 0 ? void 0 : onClickMenuCurrent.forEach(function (current) {
          ...
          if (!e.target.closest('.top-links.on-click')) {
            ...
            onClickTopMenuCurrent === null || onClickTopMenuCurrent === void 0 ? void 0 : onClickTopMenuCurrent.forEach(function (current) {
              current.classList.add('current');
            });
          }
        }, false);
      ...
      var _reset = function _reset() {
        ...
        __core.getVars.elPrimaryMenus.forEach(function (el) {
          var _el$querySelectorAll3;
          if (!body.classList.contains('is-expanded-menu')) {
            var _el$querySelector;
            (_el$querySelector = el.querySelector('.menu-container')) === null || _el$querySelector === void 0 ? void 0 : _el$querySelector.classList.remove('d-block');
          } else {
            var _el$querySelector2, _el$querySelectorAll;
            (_el$querySelector2 = el.querySelector('.menu-container')) === null || _el$querySelector2 === void 0 ? void 0 : _el$querySelector2.classList.remove('d-block', 'd-none');
            (_el$querySelectorAll = el.querySelectorAll(subMenusSel)) === null || _el$querySelectorAll === void 0 ? void 0 : _el$querySelectorAll.forEach(function (item) {
            ...
            __core.getVars.elPrimaryMenus.forEach(function (el) {
              var _el$querySelectorAll2;
              (_el$querySelectorAll2 = el.querySelectorAll('.mobile-primary-menu')) === null || _el$querySelectorAll2 === void 0 ? void 0 : _el$querySelectorAll2.forEach(function (elem) {
                elem.classList.remove('d-block');
              });
            });
          }
          (_el$querySelectorAll3 = el.querySelectorAll(subMenusSel)) === null || _el$querySelectorAll3 === void 0 ? void 0 : _el$querySelectorAll3.forEach(function (item) {
            item.classList.remove('d-block');
          });
      ...
      var _arrows = function _arrows() {
        var addArrow = function addArrow(menuItemDiv) {
          if (menuItemDiv && !menuItemDiv.querySelector('.sub-menu-indicator')) {
            var _menuItemDiv$closest;
            var arrow = document.createElement("i");
            arrow.classList.add('sub-menu-indicator');
            var customArrow = ((_menuItemDiv$closest = menuItemDiv.closest('.primary-menu')) === null || _menuItemDiv$closest === void 0 ? void 0 : _menuItemDiv$closest.getAttribute('data-arrow-class')) || 'fa-solid fa-caret-down';
      ...
      var _invert = function _invert(subMenuEl) {
        var _primaryMenu;
        ...
        (_primaryMenu = primaryMenu) === null || _primaryMenu === void 0 ? void 0 : _primaryMenu.classList.add('primary-menu-init');
      };
      var _functions = function _functions() {
      ...
      var _triggerState = function _triggerState(triggerEl, menuItemSel, subMenusSel, subMenuTriggerSel, classCheck) {
      ...
      var _current = function _current(triggerEl, menuItemSel, subMenusSel, subMenuTriggerSel) {
        [].slice.call(triggerEl.closest('.menu-container').querySelectorAll(menuItemSel)).forEach(function (item) {
          item.classList.remove('current');
        });
        var setCurrent = function setCurrent(item, menuItemSel, subMenusSel) {
          if (!__core.isHidden(item.closest(menuItemSel).querySelector(':scope > ' + subMenusSel))) {
            var _item$closest$querySe;
            item.closest(menuItemSel).classList.add('current');
            (_item$closest$querySe = item.closest(menuItemSel).querySelector(':scope > ' + subMenuTriggerSel)) === null || _item$closest$querySe === void 0 ? void 0 : _item$closest$querySe.classList.add('icon-rotate-90');
          } else {
            var _item$closest$querySe2;
            item.closest(menuItemSel).classList.remove('current');
            (_item$closest$querySe2 = item.closest(menuItemSel).querySelector(':scope > ' + subMenuTriggerSel)) === null || _item$closest$querySe2 === void 0 ? void 0 : _item$closest$querySe2.classList.remove('icon-rotate-90');
          }
        };
      ...
      var _fullWidth = function _fullWidth() {
        ...
        var headerWidth = (_document$querySelect2 = document.querySelector('.mega-menu:not(.mega-menu-full):not(.mega-menu-small) .mega-menu-content')) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.closest('.header-row').offsetWidth;
      ...
      return {
        init: function init(selector) {
          ...
          var slider = document.querySelector('.slider-element'),
            ...
            parallaxElHeight = sliderParallaxEl === null || sliderParallaxEl === void 0 ? void 0 : sliderParallaxEl.offsetHeight,
            parallaxElWidth = sliderParallaxEl === null || sliderParallaxEl === void 0 ? void 0 : sliderParallaxEl.offsetWidth,
            slInner = sliderParallaxEl === null || sliderParallaxEl === void 0 ? void 0 : sliderParallaxEl.querySelector('.slider-inner'),
          ...
          if (body.classList.contains('device-up-lg')) {
            setTimeout(function () {
              ...
              if (slFlexHeight) {
                ...
                parallaxElHeight = (_slider$querySelector = slider.querySelector('.slider-inner')) === null || _slider$querySelector === void 0 ? void 0 : _slider$querySelector.querySelector('*').offsetHeight;
    ...
    SliderMenuClass: function () {
      ...
      var _revolution = function _revolution() {
        if (!__core.getVars.elHeader.classList.contains('ignore-slider') && (__core.getVars.elBody.classList.contains('is-expanded-menu') || __core.getVars.elHeader.classList.contains('transparent-header-responsive') && !__core.getVars.elBody.classList.contains('primary-menu-open'))) {
          var activeSlide = __core.getVars.elSlider.querySelector('.active-revslide');
          _schemeChanger(activeSlide);
        }
      };
      var _schemeChanger = function _schemeChanger(activeSlide) {
        if (!activeSlide) {
          return;
        }
        ...
        if (activeSlide.classList.contains('dark')) {
          ...
          if (__core.getVars.elBody.classList.contains('dark')) {
            ...
            (_document$querySelect3 = document.querySelector('#header.transparent-header:not(.sticky-header,.semi-transparent,.floating-header)')) === null || _document$querySelect3 === void 0 ? void 0 : _document$querySelect3.querySelector('#header-wrap').classList.add('not-dark');
          } else {
            document.querySelector('#header.transparent-header:not(.semi-transparent,.floating-header)').classList.remove('dark');
            __core.getVars.elHeaderWrap.classList.remove('not-dark');
          }
      ...
      return {
        init: function init(selector) {
          ...
          selector[0].onclick = function (e) {
            ...
            (_document$getElementB = document.getElementById('top-cart')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.classList.remove('top-cart-open');
    ...
    AdaptiveColorScheme: function () {
      return {
        init: function init(selector) {
          ...
          var adaptClasses = function adaptClasses(dark) {
            if (dark) {
    ...
    PortfolioAjax: function () {
      var _newNextPrev = function _newNextPrev(portPostId) {
        ...
        if (!document.getElementById('prev-portfolio') && portPrev) {
          ...
          prevPortItem && (portNav === null || portNav === void 0 ? void 0 : portNav.insertBefore(prevPortItem, document.getElementById('close-portfolio')));
        }
        if (!document.getElementById('next-portfolio') && portNext) {
          ...
          nextPortItem && (portNav === null || portNav === void 0 ? void 0 : portNav.insertBefore(nextPortItem, document.getElementById('close-portfolio')));
        }
      };
      var _load = function _load(portPostId, prevPostPortId, getIt) {
        if (!getIt) {
          getIt = false;
        }
        var portNext = _getNext(portPostId);
        ...
        if (getIt == false) {
          ...
          fetch(portfolioDataLoader).then(function (response) {
            ...
            nextPortfolio === null || nextPortfolio === void 0 ? void 0 : nextPortfolio.classList.add('d-none');
            prevPortfolio === null || prevPortfolio === void 0 ? void 0 : prevPortfolio.classList.add('d-none');
            if (portNext) {
              nextPortfolio === null || nextPortfolio === void 0 ? void 0 : nextPortfolio.setAttribute('data-id', portNext);
              nextPortfolio === null || nextPortfolio === void 0 ? void 0 : nextPortfolio.classList.remove('d-none');
            }
            if (portPrev) {
              prevPortfolio === null || prevPortfolio === void 0 ? void 0 : prevPortfolio.setAttribute('data-id', portPrev);
              prevPortfolio === null || prevPortfolio === void 0 ? void 0 : prevPortfolio.classList.remove('d-none');
            }
      ...
      var _display = function _display() {
      ...
      var _getNext = function _getNext(portPostId) {
        var portNext = false;
      ...
      var _getPrev = function _getPrev(portPostId) {
        var portPrev = false;
      ...
      var _initAjax = function _initAjax(portPostId) {
    ...
    Cursor: function () {
      return {
        init: function init(selector) {
          ...
          var addCursorEl = function addCursorEl(selector, parent) {
    ...
    PageTransition: function () {
      return {
        init: function init(selector) {
          ...
          var endPageTransition = function endPageTransition() {
            ...
            var removePageTransition = function removePageTransition() {
    ...
    HoverAnimations: function () {
      var _t, _x;
      var _showOverlay = function _showOverlay(params) {
        clearTimeout(_x);
        _t = setTimeout(function () {
      ...
      var _hideOverlay = function _hideOverlay(params) {
        params.element.classList.add('not-animated');
      ...
      var _isInsideElement = function _isInsideElement(touch) {
    ...
    SliderParallax: function () {
      ...
      var _transform;
      var _transform2;
      var _parallax = function _parallax(_settings) {
          ...
          if (_settings.body.classList.contains('is-expanded-menu') && !_settings.isMobile) {
            if (_settings.height + _settings.sliderPx.offset + 50 > _settings.scrollPos.y) {
              ...
              if (_settings.scrollPos.y > _settings.sliderPx.offset) {
                if (_typeof(_settings.sliderPx.el.querySelector('.slider-inner')) === 'object') {
      ...
      var _offset = function _offset() {
        var _core$getVars$elHead13;
        var sliderPx = __core.getVars.sliderParallax;
        var sliderParallaxOffsetTop = 0,
          headerHeight = ((_core$getVars$elHead13 = __core.getVars.elHeader) === null || _core$getVars$elHead13 === void 0 ? void 0 : _core$getVars$elHead13.offsetHeight) || 0;
      ...
      var _setParallax = function _setParallax(xPos, yPos, el) {
        if (el) {
      ...
      var _elementFade = function _elementFade(_settings) {
     ...
     */
    Counter: function () {
      var _run = function _run(elCounter, elFormat) {
    ...
    RoundedSkills: function () {
      var _run = function _run(element, properties) {
     ...
     */
    Twitter: function () {
      var _build = function _build(tweet, element, username) {
      ...
      var _time = function _time(time_value) {
        ...
        init: function init(selector) {
          ...
          selector.forEach(function (element) {
            ...
            fetch(elLoader + '?username=' + elUser).then(function (response) {
              ...
              alert.remove();
              var i = 0;
              tweets === null || tweets === void 0 ? void 0 : tweets.some(function (tw) {
                if (i == Number(elCount)) {
                  return;
                }
     ...
     */
    Instagram: function () {
      var _get = function _get(element, loader, limit, fetchAlert) {
        ...
        init: function init(selector) {
          ...
          __core.isFuncTrue(function () {
            ...
            selector.each(function () {
              ...
              if (elRTL == 'true' || jQuery('body').hasClass('rtl')) {
                elRTL = true;
              } else {
                elRTL = false;
              }
        ...
        init: function init(selector) {
          ...
          __core.isFuncTrue(function () {
            ...
            selector.each(function () {
              ...
              elChildren.removeClass('grid-item-big').css({
                'width': ''
              });
      ...
      return {
        init: function init(selector) {
          ...
          __core.isFuncTrue(function () {
            ...
            var elTemplate = '<div class="position-fixed ' + elPosClass + ' p-3" style="z-index: 999999;">' + '<div id="' + elId + '" class="toast p-2 hide ' + elTypeClass + '" role="alert" aria-live="assertive" aria-atomic="true">' + '<div class="d-flex">' + '<div class="toast-body">' + elMsg + '</div>' + elCloseHtml + '</div>' + '</div>';
            '</div>';
            if (elTrigger == 'self') {
              if (!elTarget) {
    ...
    OnePage: function () {
      ...
      var _getSection = function _getSection(el, type) {
        var anchor;
        if (type == 'scrollTo') {
      ...
      var _getSettings = function _getSettings(el, type) {
      ...
      var _scroller = function _scroller(el, type) {
        var section = _getSection(el, type),
      ...
      var _scroll = function _scroll(section, settings, timeout) {
        setTimeout(function () {
      ...
      var _position = function _position() {
        ...
        __core.getVars.elOnePageMenus && __core.getVars.elOnePageMenus.forEach(function (el) {
          ...
          (_el$querySelector3 = el.querySelector('[data-href="#' + _current() + '"]')) === null || _el$querySelector3 === void 0 ? void 0 : _el$querySelector3.closest(__core.getVars.elOnePageParentSelector).classList.add(__core.getVars.elOnePageActiveClass);
        });
      };
      var _current = function _current() {
      ...
      var _settings = function _settings(section, element) {
        var body = __core.getVars.elBody.classList;
        ...
        parentSettings.offset = (parent === null || parent === void 0 ? void 0 : parent.getAttribute('data-offset')) || options.offset;
        parentSettings.speed = (parent === null || parent === void 0 ? void 0 : parent.getAttribute('data-speed')) || options.speed;
        parentSettings.easing = (parent === null || parent === void 0 ? void 0 : parent.getAttribute('data-easing')) || options.easing;
        var elementSettings = {
          ...
          __core.isFuncTrue(function () {
            ...
            selector.each(function () {
              ...
              element.find('form').validate({
                errorPlacement: function errorPlacement(error, elementItem) {
    ...
    Conditional: function () {
      var _eval = function _eval(field, value, conditions, check, target) {
        if (!field || !conditions) {
          return false;
        }
        var fulfilled = false;
     ...
     */
    Cookies: function () {
      var _resetPage = function _resetPage(btn) {
      ...
      return {
        init: function init(selector) {
          ...
          var cookieBar = document.querySelector('.gdpr-settings'),
            elSpeed = (cookieBar === null || cookieBar === void 0 ? void 0 : cookieBar.getAttribute('data-speed')) || 300,
            elExpire = (cookieBar === null || cookieBar === void 0 ? void 0 : cookieBar.getAttribute('data-expire')) || 30,
            elDelay = (cookieBar === null || cookieBar === void 0 ? void 0 : cookieBar.getAttribute('data-delay')) || 1500,
            elPersist = cookieBar === null || cookieBar === void 0 ? void 0 : cookieBar.getAttribute('data-persistent'),
            elDirection = 'bottom',
            elHeight = (cookieBar === null || cookieBar === void 0 ? void 0 : cookieBar.offsetHeight) + 100,
            elWidth = (cookieBar === null || cookieBar === void 0 ? void 0 : cookieBar.offsetWidth) + 100,
            elSize,
            elSettings = document.querySelector('.gdpr-cookie-settings'),
            elSwitches = elSettings === null || elSettings === void 0 ? void 0 : elSettings.querySelectorAll('[data-cookie-name]');
          ...
          if (cookieBar) {
            if (cookieBar !== null && cookieBar !== void 0 && cookieBar.classList.contains('gdpr-settings-sm') && cookieBar !== null && cookieBar !== void 0 && cookieBar.classList.contains('gdpr-settings-right')) {
              elDirection = 'right';
            } else if (cookieBar !== null && cookieBar !== void 0 && cookieBar.classList.contains('gdpr-settings-sm')) {
              elDirection = 'left';
            }
            if (elDirection == 'left') {
              elSize = -elWidth;
          ...
          elSwitches === null || elSwitches === void 0 ? void 0 : elSwitches.forEach(function (el) {
          ...
          (_document$querySelect4 = document.querySelectorAll('.gdpr-container')) === null || _document$querySelect4 === void 0 ? void 0 : _document$querySelect4.forEach(function (element) {
            ...
            if (typeof getCookie !== 'undefined' && getCookie == '1' && cookiesAllowed) {
              ...
              if (elContentAjax) {
                fetch(elContentAjax).then(function (response) {
                  ...
                  element === null || element === void 0 ? void 0 : element.insertAdjacentHTML('beforeend', parsedHTML.body.innerHTML);
                })["catch"](function (err) {
                  console.log(err);
                });
              } else {
     ...
     */
    ReadMore: function () {
      var _HEXtoRGBA = function _HEXtoRGBA(hex, op) {
        var c;
    ...
    PricingSwitcher: function () {
      var _staticValue;
      var _switcher = function _switcher(check, switcher, pricing, defClass, actClass) {
        var _switcher$querySelect, _pricing$querySelecto;
        var value;
        ...
        value = _staticValue;
        (_switcher$querySelect = switcher.querySelectorAll('.pts-switch')) === null || _switcher$querySelect === void 0 ? void 0 : _switcher$querySelect.forEach(function (elem) {
        ...
        (_pricing$querySelecto = pricing.querySelectorAll('.pts-content')) === null || _pricing$querySelecto === void 0 ? void 0 : _pricing$querySelecto.forEach(function (elem) {
          elem.classList.add('d-none');
        });
        if (check.type == 'checkbox') {
        ...
        defClass.split(" ").forEach(function (_class) {
          var _switcher$querySelect2;
          (_switcher$querySelect2 = switcher.querySelector('.pts-' + value)) === null || _switcher$querySelect2 === void 0 ? void 0 : _switcher$querySelect2.classList.remove(_class);
        });
        actClass.split(" ").forEach(function (_class) {
          var _switcher$querySelect3;
          (_switcher$querySelect3 = switcher.querySelector('.pts-' + value)) === null || _switcher$querySelect3 === void 0 ? void 0 : _switcher$querySelect3.classList.add(_class);
        });
            ...
            el.onclick = function (e) {
              ...
              fetch(elLoader).then(function (response) {
                ...
                if (elContentPlacement == 'append') {
                  elContainer === null || elContainer === void 0 ? void 0 : elContainer.insertAdjacentHTML('beforeend', parsedHTML.body.innerHTML);
                } else {
                  elContainer === null || elContainer === void 0 ? void 0 : elContainer.insertAdjacentHTML('afterbegin', parsedHTML.body.innerHTML);
                }
                ...
                elContainer === null || elContainer === void 0 ? void 0 : elContainer.prepend(errorDIV, ': ' + err);
              });
            };
          });
        }
    ...
    SchemeToggle: function () {
      var _toggle = function _toggle(element) {
        var sibling = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
          ...
          __core.isFuncTrue(function () {
            ...
            selector.forEach(function (el) {
              ...
              clipboards[count] = new ClipboardJS(trigger, {
                target: function target(content) {
    ...
    TextSplitter: function () {
      var _getText = function _getText(element) {
        return element.textContent || element.innerText;
      };
      var _joiner = function _joiner(arr) {
        var joiner = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'span';
        var glue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ' ';
        return arr.map(function (chunk) {
          return '<' + joiner + '>' + chunk + '</' + joiner + '>';
        }).join(glue);
      };
      var _words = function _words(element) {
        var joiner = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'span';
        return _joiner(_getText(element).split(' '), joiner, ' ');
      };
      var _letters = function _letters(element) {
        var joiner = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'span';
        return _joiner(_getText(element).split(''), joiner, '');
      };
      var _splitter = function _splitter(el) {
        var _el$querySelectorAll4;
        var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'word';
        el.innerHTML = type == 'letter' ? _letters(el) : _words(el);
        (_el$querySelectorAll4 = el.querySelectorAll('span')) === null || _el$querySelectorAll4 === void 0 ? void 0 : _el$querySelectorAll4.forEach(function (elem, index) {
    ...
    MediaActions: function () {
      ...
      var _volume = function _volume(mediaEl) {
      ...
      var _time = function _time(duration) {
    ...
    ViewportDetect: function () {
      var _setBSTheme = function _setBSTheme(target) {
    ...
    ScrollDetect: function () {
      var _detects = [];
      var _percent = function _percent(params) {
        var percent = 0,
          ratio = 0,
          start = 0,
          end = 0;
        var onScroll = function onScroll(params) {
          fastdom.measure(function () {
      ...
      return {
        init: function init(selector) {
          ...
          __core.isFuncTrue(function () {
            ...
            var initParams = function initParams(selector) {
              _detects = [];
      ...
      return {
        init: function init(selector) {
          ...
          __core.isFuncTrue(function () {
            ...
            var tabTargetShow = function tabTargetShow(target) {
...
/***/ "./resources/sass/canvas/style.scss":
/*!******************************************!*\
  !*** ./resources/sass/canvas/style.scss ***!
  \******************************************/
...
/***/ "./resources/sass/canvas/demos/forum/forum.css":
/*!*****************************************************!*\
  !*** ./resources/sass/canvas/demos/forum/forum.css ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/sass/canvas/css/font-icons.css":
/*!**************************************************!*\
  !*** ./resources/sass/canvas/css/font-icons.css ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/sass/canvas/css/custom.css":
/*!**********************************************!*\
  !*** ./resources/sass/canvas/css/custom.css ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	__webpack_require__.O(undefined, ["css/font-icons","css/custom","css/style","css/koros"], () => (__webpack_require__("./resources/sass/canvas/js/functions.bundle.js")))
/******/ 	__webpack_require__.O(undefined, ["css/font-icons","css/custom","css/style","css/koros"], () => (__webpack_require__("./resources/sass/canvas/style.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/font-icons","css/custom","css/style","css/koros"], () => (__webpack_require__("./resources/sass/canvas/demos/forum/forum.css")))
/******/ 	__webpack_require__.O(undefined, ["css/font-icons","css/custom","css/style","css/koros"], () => (__webpack_require__("./resources/sass/canvas/css/font-icons.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/font-icons","css/custom","css/style","css/koros"], () => (__webpack_require__("./resources/sass/canvas/css/custom.css")))
