    ...
    <body>
                ...
                <div class="content py-0">
                    <div class="row font-size-sm">
                        ...
                        <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                            <a class="font-w600" href="https://www.focusbranding.ie" target="_blank">Focus Branding</a> &copy; <span data-toggle="year-copy"></span>
                        </div>
                    </div>
                </div>
            </footer>
        ...
        <script>
            ...
            function deleteItem(id, url) {
                Swal.fire({
                    title: 'Obriši..!',
                    text: "Jeste li zaista sigurni da želite obrisati ovaj podatak? Ova akcija se nakon klika ne može poništiti.",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then(response => {
                            ...
                            if (response.data.success) {
                                ...
                                let message = 'Neuspješno brisanje.!!';
