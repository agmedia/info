                ...
                <nav class="space-y-1 p-4">
                    ...
                    <details class="group rounded-lg" @if($contentOpen) open @endif>
                        ...
                        <div class="ml-3 mt-1 space-y-1 border-l border-slate-200 pl-4">
                            <a
                                ...
                                class="sidebar-dropdown-link block rounded-lg font-medium {{ $contentCategoriesActive ? 'is-active-leaf' : 'text-slate-700 hover:bg-slate-100' }}"
                            >
                                <span class="flex items-center gap-2">
                        ...
                        <details class="group rounded-lg" @if($messagesOpen) open @endif>
                            ...
                            <div class="ml-3 mt-1 space-y-1 border-l border-slate-200 pl-4">
                                @if ($canViewContactMessages)
                                    <a
                                        href="{{ route('admin.messages.contact.index') }}"
                                        class="sidebar-dropdown-link block rounded-lg font-medium {{ $messagesContactActive ? 'is-active-leaf' : 'text-slate-700 hover:bg-slate-100' }}"
                                    >
                                        <span class="flex items-center gap-2">
                                            <span class="sidebar-dot"></span>
                                            <span>{{ __('admin.layout.menu.contact') }}</span>
                                        </span>
                                    </a>
                                @endif
                                @if ($canViewCollaborationAssessmentMessages)
                                    <a
                                        href="{{ route('admin.messages.collaboration-assessment.index') }}"
                                        class="sidebar-dropdown-link block rounded-lg font-medium {{ $messagesCollaborationAssessmentActive ? 'is-active-leaf' : 'text-slate-700 hover:bg-slate-100' }}"
                                    >
                                        <span class="flex items-center gap-2">
                                            <span class="sidebar-dot"></span>
                                            <span>{{ __('admin.layout.menu.collaboration_assessment') }}</span>
                                        </span>
                                    </a>
                                @endif
                    ...
                    <details class="group rounded-lg" @if($settingsOpen) open @endif>
                        ...
                        <div class="ml-3 mt-1 space-y-1 border-l border-slate-200 pl-2">
                            ...
                            @if ($canManageLocalLanguages)
                                <a
                                    href="{{ route('admin.settings.local.languages') }}"
                                    class="sidebar-dropdown-link block rounded-lg font-medium {{ request()->routeIs('admin.settings.local.languages') ? 'is-active-leaf' : 'text-slate-700 hover:bg-slate-100' }}"
                                >
                                    <span class="flex items-center gap-2">
                                        <span class="sidebar-dot"></span>
                                        <span>{{ __('admin.layout.menu.languages') }}</span>
                                    </span>
                                </a>
                            @endif
                ...
                <header class="sticky top-0 z-10 flex h-16 items-center justify-between border-b border-slate-200 bg-white px-4 md:px-6">
                    <div class="flex min-w-0 items-center gap-3">
                        <button
                            ...
                            aria-label="{{ __('admin.layout.open_navigation') }}"
