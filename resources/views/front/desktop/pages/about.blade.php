            ...
            <div class="ac-about-container">
                <div class="ac-about-hero-grid">
                    ...
                    <div class="ac-about-hero-media">
                        <div class="ac-about-hero-collage" aria-label="{{ str_starts_with(strtolower((string) $locale), 'hr') ? 'Fotografije tima i ureda' : 'Team and office photos' }}">
                            @foreach ($aboutHeroPhotos as $photo)
                                <figure class="ac-about-image {{ $photo['class'] }}">
                                    <img
                                        src="{{ $photo['src'] }}"
                                        alt="{{ $photo['alt'] }}"
                                        width="760"
                        ...
                        <div class="ac-about-hero-bottom">
                            ...
                            <figure class="ac-about-image {{ $aboutBottomPhoto['class'] }}">
                                <img
                                    src="{{ $aboutBottomPhoto['src'] }}"
                                    alt="{{ $aboutBottomPhoto['alt'] }}"
                                    width="430"
                                    height="320"
                                    loading="lazy"
                                    decoding="async"
