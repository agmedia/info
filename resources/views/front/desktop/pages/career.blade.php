                            ...
                            @foreach ($careerProcessSteps as $step)
                                <article class="ac-support-story-card ac-career-process-card">
                                    <span class="ac-support-story-card-icon ac-career-process-icon" aria-hidden="true">
                                        <svg class="ac-career-process-fa" viewBox="{{ $step['icon_view_box'] }}" fill="currentColor">
                                            <use href="{{ $step['icon_href'] }}"></use>
                                        </svg>
                                    </span>
                                    <p class="ac-career-process-step-label">{{ $step['step'] }}</p>
                                    <h3>{{ $step['title'] }}</h3>
                                    <p class="ac-support-story-card-lead ac-career-process-copy">{{ $step['description'] }}</p>
                                </article>
                            @endforeach
                        </div>
                    </div>
