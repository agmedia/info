...
<div id="page">
    <div class="header header-fixed header-logo-center header-auto-show">
        <a href="{{ route('home') }}" class="header-title">@yield('header_title', (string) ($storeSettings['branding']['store_name'] ?? 'AG Info'))</a>
    ...
    <div id="footer-bar" class="footer-bar-6">
        ...
        <a href="{{ route('blog.index') }}" class="{{ request()->routeIs('blog.*') ? 'active-nav' : '' }}"><i class="fa fa-newspaper"></i><span>Blog</span></a>
        <a href="{{ route('faq.index') }}" class="{{ request()->routeIs('faq.*') ? 'active-nav circle-nav' : 'circle-nav' }}"><i class="fa fa-circle-question"></i><span>FAQ</span></a>
        <a href="{{ route('contact.create') }}" class="{{ request()->routeIs('contact.*') ? 'active-nav' : '' }}"><i class="fa fa-envelope"></i><span>Contact</span></a>
        <a href="#" data-menu="menu-main"><i class="fa fa-bars"></i><span>Menu</span></a>
    </div>

    <div class="page-title page-title-fixed">
        <h1>@yield('page_title', 'Info')</h1>
