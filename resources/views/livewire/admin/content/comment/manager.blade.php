    ...
    <div class="admin-panel admin-search-panel p-6">
        <div class="flex items-end justify-between gap-4">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-600">{{ __('Review and moderate user comments across blog, page, and FAQ content.') }}</p>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($rows as $row)
                        @php
                            ...
                            $targetLabel = '-';
                            if ($commentable instanceof \App\Models\Content\Blog\BlogPost) {
