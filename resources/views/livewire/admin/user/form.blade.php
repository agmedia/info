    ...
    <div class="admin-panel admin-search-panel p-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-2xl font-semibold tracking-tight text-slate-900">{{ __('Edit Admin User') }}</h1>
                <p class="mt-2 text-sm text-slate-600">{{ __('Update core admin account data and access in one place.') }}</p>
            </div>
