...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.front.page-title-band','data' => ['breadcrumbs' => $pageTitleBreadcrumbs,'sectionClass' => 'ac-about-title-band','breadcrumbClass' => 'ac-about-title-breadcrumb']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($pageTitleBreadcrumbs),'section-class' => 'ac-about-title-band','breadcrumb-class' => 'ac-about-title-breadcrumb']); ?>
            <div class="ac-page-title-copy">
                <h1><?php echo e($pageTitle); ?></h1>
                <p><?php echo e($heroTitle); ?></p>
            </div>
            ...
            <div class="ac-about-container">
                <div class="ac-about-hero-grid">
                    <div class="ac-about-hero-copy">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($hero['eyebrow'] ?? '')) !== ''): ?>
                            <p class="ac-about-kicker"><?php echo e($hero['eyebrow']); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <h2 id="ac-about-hero-title"><?php echo e($heroTitle); ?></h2>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroLead !== ''): ?>
                            <p class="ac-about-lead"><?php echo e($heroLead); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <div class="ac-about-copy-stack">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = (array) ($story['paragraphs'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <section class="ac-about-values" aria-labelledby="ac-about-values-title">
            <div class="ac-about-container">
                <div class="ac-about-section-head">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($values['kicker'] ?? '')) !== ''): ?>
                        <p class="ac-about-kicker"><?php echo e($values['kicker']); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <h2 id="ac-about-values-title"><?php echo e($values['title'] ?? 'Vrijednosti'); ?></h2>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($values['intro'] ?? '')) !== ''): ?>
                        <p><?php echo e($values['intro']); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
        ...
        <section class="ac-about-why" aria-labelledby="ac-about-why-title">
            <div class="ac-about-container">
                <div class="ac-about-split-grid">
                    <div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($why['kicker'] ?? '')) !== ''): ?>
                            <p class="ac-about-kicker"><?php echo e($why['kicker']); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <h2 id="ac-about-why-title"><?php echo e($why['title'] ?? 'Zašto postojimo'); ?></h2>
                    ...
                    <div class="ac-about-copy-stack ac-about-copy-stack--large">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = (array) ($why['paragraphs'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(trim((string) $paragraph) === '') continue; ?>
                            <p><?php echo e($paragraph); ?></p>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
        ...
        <section class="ac-about-team" aria-labelledby="ac-about-team-title">
            <div class="ac-about-container">
                <div class="ac-about-team-head">
                    <div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($team['kicker'] ?? '')) !== ''): ?>
                            <p class="ac-about-kicker"><?php echo e($team['kicker']); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <h2 id="ac-about-team-title"><?php echo e($team['title'] ?? 'Tim'); ?></h2>
                    </div>
                    ...
                    <div class="ac-about-copy-stack">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($team['intro'] ?? '')) !== ''): ?>
                            <p class="ac-about-team-intro"><?php echo e($team['intro']); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="ac-about-stat-grid">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = (array) ($team['stats'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $stat = is_array($stat) ? $stat : [];
                            $statValue = trim((string) ($stat['value'] ?? ''));
                        ?>

                        <?php if($statValue === '') continue; ?>

                        <div class="ac-about-stat-item">
                            <strong><?php echo e($statValue); ?></strong>
            ...
            <div class="ac-about-container">
                <div class="ac-about-split-grid">
                    <div>
                        ...
                        <h2 id="ac-about-culture-title"><?php echo e($culture['title'] ?? 'Naša kultura'); ?></h2>
            ...
            <div class="ac-about-container">
                <div class="ac-about-responsibility-grid">
                    <div>
                        ...
                        <h2 id="ac-about-responsibility-title"><?php echo e($responsibility['title'] ?? ''); ?></h2>
            ...
            <div class="ac-about-container">
                <div class="ac-about-reference-head">
                    <div>
                        ...
                        <h2 id="ac-about-references-title"><?php echo e($references['title'] ?? 'Reference'); ?></h2>
                    </div>
