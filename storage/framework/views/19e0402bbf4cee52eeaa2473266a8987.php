        ...
        <section class="ac-tool-intro" aria-labelledby="ac-assessment-title">
            <div class="ac-tool-container ac-tool-intro-layout">
                <div class="ac-tool-intro-heading">
                    ...
                    <h1 class="values-title services-index-intro-title ac-tool-display-title" id="ac-assessment-title" data-words-slide-from-right aria-label="<?php echo e(__('assessment.heading')); ?>">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $assessmentHeadingWords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $word): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="values-word animation-index-<?php echo e($loop->index); ?> <?php echo e($loop->last && count($assessmentHeadingWords) > 1 ? 'is-accent' : ''); ?>" aria-hidden="true"><?php echo e($word); ?></span>
                ...
                <div class="front-contact-layout ac-assessment-layout">
                    ...
                    >
                        ...
                        <div class="front-contact-form-head">
                            ...
                            <h2 id="ac-assessment-form-title"><?php echo e(__('assessment.form.title')); ?></h2>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="front-contact-form-actions">
                            <button type="submit" class="editorial-dark-button ac-tool-submit">
                                <span><?php echo e(__('assessment.form.submit')); ?></span>
                                <i class="fa-light fa-arrow-up-right" aria-hidden="true"></i>
                            </button>
                        </div>
                    </form>

                    <aside class="front-contact-sidebar content-reveal animation-index-1" data-image-reveal aria-label="<?php echo e(__('assessment.sidebar.title')); ?>">
                        <div class="front-contact-panel front-contact-panel--direct">
                            ...
                            <ul class="front-contact-direct-list">
                                <li>
                                    ...
                                    <span>
                                        <small><?php echo e(__('assessment.sidebar.point_1_label')); ?></small>
                                ...
                                <li>
                                    ...
                                    <span>
                                        <small><?php echo e(__('assessment.sidebar.point_2_label')); ?></small>
