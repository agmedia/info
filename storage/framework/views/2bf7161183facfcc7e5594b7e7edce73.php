    ...
    <div class="mx-auto w-full max-w-[1320px] px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div class="front-footer-legal">
            ...
            <div class="front-footer-legal-links">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = (array) ($storeSettings['footer']['bottom_links'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
