...
<head>
    ...
    <style>
        .front-desktop-shell {
            ...
            --front-fixed-watermark: url("<?php echo e(asset('front-theme/images/bck-logo.png')); ?>");
    ...
    <div class="front-header-main">
        <div class="front-header-row flex w-full items-center justify-between gap-2.5 sm:px-8 xl:px-10">
            ...
            <div class="front-header-actions hidden min-h-[84px] items-center gap-2.5 xl:flex">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showLeaseCalculatorLink): ?>
    ...
    <section id="video-sadrzaj" class="front-hero-video-section w-full border-b border-black/20 bg-black">
        <div class="front-hero-video-wrap relative w-full overflow-hidden">
            ...
            <div class="front-hero-video-content absolute inset-0 flex items-center justify-center px-6 text-center">
                <div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($homeHeroKicker !== ''): ?>
                        <p class="front-kicker mb-4 justify-center text-white/80"><?php echo e($homeHeroKicker); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <h1 class="front-hero-video-title text-white"><?php echo e($homeHeroTitle); ?></h1>
                    <p class="front-hero-video-subtitle mt-5 text-white/90"><?php echo e($homeHeroSubtitle); ?></p>
                    <div class="front-hero-cta-row mt-8 flex flex-wrap items-center justify-center gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($homeHeroPrimaryLabel !== '' && $homeHeroPrimaryUrl !== ''): ?>
                            <a href="<?php echo e($homeHeroPrimaryUrl); ?>" class="front-hero-cta front-hero-cta-primary inline-flex items-center justify-center px-6 py-3 text-[11px] font-semibold uppercase tracking-[0.12em]">
                                <?php echo e($homeHeroPrimaryLabel); ?>

                            </a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($homeHeroSecondaryLabel !== '' && $homeHeroSecondaryUrl !== ''): ?>
                            <a href="<?php echo e($homeHeroSecondaryUrl); ?>" class="front-hero-cta front-hero-cta-secondary inline-flex items-center justify-center px-6 py-3 text-[11px] font-semibold uppercase tracking-[0.12em]">
                                <?php echo e($homeHeroSecondaryLabel); ?>
        ...
        <div class="front-hero-stats-card relative z-10" data-home-hero-stats>
            <div class="grid w-full grid-cols-2 md:grid-cols-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $homeStats->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    ?>
                <article class="front-hero-stat-card <?php echo e($loop->last ? 'front-hero-stat-card--wide' : ''); ?> px-6 py-8 text-center" data-home-hero-stat style="--front-hero-stat-delay: <?php echo e($loop->index * 320); ?>ms;">
                    ...
                    <div class="front-hero-stat-value-shell" data-home-hero-display data-home-hero-display-value="<?php echo e($statDisplayValue); ?>">
                        <p class="front-hero-stat-value" data-home-hero-count data-count-to="<?php echo e($statCountTo !== '' ? $statCountTo : $statValue); ?>" data-count-suffix="<?php echo e($statSuffix); ?>"><?php echo e($statValue); ?></p>
                    </div>
                    <span class="front-hero-stat-accent" aria-hidden="true"></span>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statLabel !== ''): ?>
                        <p class="front-hero-stat-label"><?php echo e($statLabel); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
    ...
    <div class="mx-auto w-full max-w-[1320px] px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div class="front-footer-certification-row">
            ...
            <div class="front-footer-eu-funding">
                <img
                    src="<?php echo e(asset($footerEuFundingLogo)); ?>"
