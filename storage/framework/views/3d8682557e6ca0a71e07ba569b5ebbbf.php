<div class="space-y-6">
    <div class="admin-panel admin-search-panel p-6">
        <div class="flex items-end justify-between gap-4">
            <div>
                <h1 class="text-xl font-semibold tracking-tight"><?php echo e(__('Blog Posts')); ?></h1>
                <p class="mt-1 text-sm text-slate-600"><?php echo e(__('Manage blog content with locale-specific slugs and SEO fields.')); ?></p>
            ...
            <div class="flex w-[64rem] max-w-full items-end justify-end gap-3">
                ...
                <a href="<?php echo e(route('admin.content.blog.create', ['locale' => $locale])); ?>" class="rounded-xl bg-cyan-700 px-4 py-2 text-sm font-semibold text-white hover:bg-cyan-800">
            ...
            <table class="admin-items-table min-w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                        ...
                        <tr>
                            ...
                            <td class="px-3 py-2 text-right">
                                <div class="inline-flex items-center gap-1">
                                    <a href="<?php echo e(route('admin.content.blog.edit', ['post' => $row->id, 'locale' => $locale])); ?>" class="rounded-lg border border-slate-300 px-2 py-1 text-xs font-semibold text-slate-700 hover:bg-slate-100">
                                        <?php echo e(__('Edit')); ?>
                                    ...
                                    <button
                                        ...
                                        wire:confirm="<?php echo e(__('Delete this blog post?')); ?>"
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="8" class="px-3 py-8 text-center text-sm text-slate-500"><?php echo e(__('No blog posts yet.')); ?></td>
                        </tr>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </tbody>
            </table>
...
</div><?php /**PATH /Users/tomek/Herd/info/resources/views/livewire/admin/content/blog/manager.blade.php ENDPATH**/ ?>