                ...
                <div class="ac-audit-editorial-shell">
                    <article class="ac-audit-editorial-section ac-audit-editorial-section--overview">
                        <div class="ac-audit-section-head ac-audit-section-head--center">
                            <p class="ac-family-section-kicker"><?php echo e($overviewSection['kicker'] ?? 'REVIZIJA'); ?></p>
                            <h2 id="ac-audit-overview-title"><?php echo e($overviewSection['title'] ?? 'Što je revizija?'); ?></h2>
                    ...
                    <article class="ac-audit-editorial-section">
                        <div class="ac-audit-section-head ac-audit-section-head--center">
                            ...
                            <h2><?php echo e($servicesSection['title'] ?? 'Naše revizijske usluge'); ?></h2>
            ...
            <div class="ac-service-cta-container">
                <div class="ac-service-cta-card">
                    <div class="ac-service-cta-copy">
                        <h2 id="ac-audit-meeting-title"><?php echo e($meetingTitle); ?></h2>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasAuditPosts || $hasServiceVideos): ?>
    <?php if (! $__env->hasRenderedOnce('541c2399-6502-463a-991e-ab06edb02765')): $__env->markAsRenderedOnce('541c2399-6502-463a-991e-ab06edb02765'); ?>
        <?php $__env->startPush('styles'); ?>
            <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@splidejs/splide@4.1.4/dist/css/splide.min.css">
        <?php $__env->stopPush(); ?>
    <?php endif; ?>

    <?php if (! $__env->hasRenderedOnce('4b86d3eb-d45f-4d96-a5ff-b358805ac6d0')): $__env->markAsRenderedOnce('4b86d3eb-d45f-4d96-a5ff-b358805ac6d0'); ?>
