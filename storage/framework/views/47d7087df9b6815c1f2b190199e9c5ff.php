<div class="space-y-6">
    <div class="admin-panel admin-search-panel p-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500"><?php echo e(__('Content / Calls')); ?></p>
                <h1 class="mt-2 text-2xl font-semibold tracking-tight text-slate-900"><?php echo e($isEdit ? __('Edit Call Post') : __('Create Call Post')); ?></h1>
                <p class="mt-2 text-sm text-slate-600"><?php echo e(__('Core call data, locale content and SEO.')); ?></p>
            </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="sm:col-span-7 flex items-end gap-3" style="grid-column: span 7;">
                        <button
                            ...
                            aria-label="<?php echo e(__('Toggle call post active state')); ?>"
                        >
                ...
                <div class="mt-4" wire:key="call-post-body-<?php echo e($postId ?? 'new'); ?>-<?php echo e($form['locale']); ?>">
                    <label for="call-post-body-html" class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Body')); ?></label>
                    <textarea id="call-post-body-html" rows="14" wire:model.live.debounce.300ms="form.body_html" data-quill-editor data-quill-image-upload-url="<?php echo e(route('admin.content.calls.editor-image.upload')); ?>" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm"></textarea>
                ...
                <div class="mt-4 grid gap-4 xl:grid-cols-2">
                    <div class="rounded-xl border border-slate-200 p-4">
                        <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Kategorije poziva')); ?></p>
...
[$__name, $__params] = $__split('admin.media.manager', ['modelClass' => \App\Models\Content\Call\CallPost::class,'modelId' => $postId,'locale' => $form['locale']]);

$key = 'call-post-media-manager-'.($postId ?? 'new').'-'.$form['locale'];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2375780974-0', 'call-post-media-manager-'.($postId ?? 'new').'-'.$form['locale']);
...
?>
        ...
        <div class="admin-form-actions flex items-center gap-2 pt-2">
            <button type="submit" class="rounded-xl bg-cyan-700 px-4 py-2 text-sm font-semibold text-white hover:bg-cyan-800">
                <?php echo e($isEdit ? __('Update Call Post') : __('Create Call Post')); ?>
...
</div><?php /**PATH /Users/tomek/Herd/info/resources/views/livewire/admin/content/call/form.blade.php ENDPATH**/ ?>