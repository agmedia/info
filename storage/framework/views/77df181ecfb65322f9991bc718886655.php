...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slides->isNotEmpty()): ?>
    <?php if (! $__env->hasRenderedOnce('950b79e4-fa08-4c3c-a041-167ae08166b9')): $__env->markAsRenderedOnce('950b79e4-fa08-4c3c-a041-167ae08166b9'); ?>
    ...
    <?php if (! $__env->hasRenderedOnce('295e2e7b-237a-4604-8389-3a5daca755a0')): $__env->markAsRenderedOnce('295e2e7b-237a-4604-8389-3a5daca755a0'); ?>
        <?php $__env->startPush('scripts'); ?>
            <script>
                (function () {
                    const init = function () {
