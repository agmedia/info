...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.front.page-title-band','data' => ['breadcrumbs' => $pageTitleBreadcrumbs,'sectionClass' => 'ac-career-title-band','breadcrumbClass' => 'ac-career-title-breadcrumb']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($pageTitleBreadcrumbs),'section-class' => 'ac-career-title-band','breadcrumb-class' => 'ac-career-title-breadcrumb']); ?>
            <div class="ac-page-title-copy">
                <h1><?php echo e($careerPageTitle); ?></h1>
                <p><?php echo e($careerHeroTitle); ?></p>
            </div>
...
<?php endif; ?>
            ...
            <div class="ac-career-container">
                <div class="ac-career-hero-grid">
                    <div class="ac-career-hero-copy">
                        ...
                        <h2 id="ac-career-hero-title"><?php echo e($careerHeroTitle); ?></h2>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($careerHeroHighlight !== ''): ?>
                            <p class="ac-career-hero-highlight"><?php echo e($careerHeroHighlight); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <div class="ac-career-copy-stack">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $careerIntroBody; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <p><?php echo e($paragraph); ?></p>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($careerValues !== []): ?>
                    ...
                    <div class="ac-career-collage" aria-label="Fotografije ureda i tima">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $careerCollageTopPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <figure class="ac-career-photo <?php echo e($photo['class']); ?>">
                                <img
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $careerCollageBottomPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <figure class="ac-career-photo <?php echo e($photo['class']); ?>">
                                <img
                                    src="<?php echo e($photo['src']); ?>"
                                    alt="<?php echo e($photo['alt']); ?>"
            ...
            <div class="ac-career-container">
                <div class="ac-career-impact-head">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($careerProcess['kicker'] ?? '')) !== ''): ?>
                        <p class="ac-career-kicker"><?php echo e($careerProcess['kicker']); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($careerProcessTitle !== ''): ?>
                        <h2 id="ac-career-impact-title"><?php echo e($careerProcessTitle); ?></h2>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($careerProcess['intro'] ?? '')) !== ''): ?>
                        <p class="ac-career-impact-intro"><?php echo e($careerProcess['intro']); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($careerStories !== []): ?>
                    ...
                    <div class="ac-career-story-grid">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $careerStories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="ac-career-story-card">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim($story['kicker']) !== ''): ?>
                                    <p class="ac-career-kicker"><?php echo e($story['kicker']); ?></p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="ac-career-container">
                <div class="ac-career-openings-grid">
                    <div class="ac-career-openings-copy">
                        ...
                        <h2 id="ac-career-openings-title"><?php echo e($careerApplicationTitle); ?></h2>
                                ...
                                <div>
                                    ...
                                    <div class="ac-career-form-file-wrap">
                                        ...
                                        <div class="ac-career-form-file-ui">
                                            <span class="ac-career-form-file-button"><?php echo e(__('career.form.cv_button')); ?></span>
    ...
    <style>
        ...
        .ac-career-video-placeholder {
            ...
            background:
                ...
                url('<?php echo e(asset('front-theme/images/careers/collage-meeting.jpg')); ?>') center / cover no-repeat;
            color: #ffffff;
        }
