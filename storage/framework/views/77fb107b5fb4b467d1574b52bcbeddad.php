                        ...
                        <div class="ac-career-intro-copy-wrap">
                            <div class="ac-career-intro-copy">
                                <div class="ac-career-intro-heading">
                                    <h2><?php echo e($careerIntro['title'] ?? ''); ?></h2>
                                </div>
                                <div class="ac-career-intro-body">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($careerIntro['highlight'] ?? '')) !== ''): ?>
                                        <p class="ac-career-intro-highlight"><?php echo e($careerIntro['highlight']); ?></p>
                            ...
                            <div class="ac-support-story-shell">
                                <div class="ac-services-head ac-support-story-head ac-career-process-head">
                                    <div class="ac-services-eyebrow">
                                        ...
                                        <p class="ac-services-kicker"><?php echo e($careerProcess['kicker'] ?? ''); ?></p>
                                        <span class="ac-services-eyebrow-line" aria-hidden="true"></span>
                                    </div>
                                    <h2 id="ac-career-process-title" aria-label="<?php echo e($careerProcessTitleAria); ?>">
                                        <span><?php echo e($careerProcess['title_line_one'] ?? ''); ?></span>
                                        <span><?php echo e($careerProcess['title_line_two'] ?? ''); ?></span>
                                    </h2>
                                    <p class="ac-services-intro"><?php echo e($careerProcess['intro'] ?? ''); ?></p>
                    ...
                    <div class="ac-career-application-shell">
                        <div class="ac-career-intro-copy-wrap ac-career-application-copy-wrap">
                            <div class="ac-career-intro-copy ac-career-application-copy">
                                <div class="ac-career-intro-heading">
                                    <h2><?php echo e($careerApplication['title'] ?? ''); ?></h2>
                                </div>
                                <div class="ac-career-intro-body">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($careerApplication['highlight'] ?? '')) !== ''): ?>
                                        <p class="ac-career-intro-highlight"><?php echo e($careerApplication['highlight']); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="ac-career-form-wrap">
                            <div class="ac-career-form-card">
                                <div class="ac-career-form-head">
                                    ...
                                    <h3><?php echo e(trim((string) ($careerFormContent['title'] ?? '')) ?: __('career.form.title')); ?></h3>
