...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($usesStandardHero): ?>
            <div class="admin-panel admin-form-panel p-6">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isServicesIndexTemplate): ?>
                <div id="services-index-editor" class="admin-panel admin-form-panel p-6 scroll-mt-24">
                    <p class="admin-section-title"><?php echo e(__('Services Overview')); ?></p>

                    <div class="mt-4 grid gap-3 md:grid-cols-2">
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Title Lead')); ?></label>
                        ...
                        <div>
                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Title Accent')); ?></label>
                    ...
                    <div class="mt-6">
                        <div class="mb-3 flex items-center justify-between gap-3">
                            <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Outro Paragraphs')); ?></p>
                        ...
                        <div class="space-y-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ($translationPayload['showcase']['outro'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div>
                                    <div class="mb-1 flex items-center justify-between gap-3">
                                        ...
                                        <button type="button" wire:click="removeTranslationListItem('showcase.outro', <?php echo e($index); ?>)" class="text-xs font-semibold text-rose-600 hover:text-rose-700"><?php echo e(__('Remove')); ?></button>
                                    </div>
                                    <textarea rows="4" wire:model="form.translation_payload.showcase.outro.<?php echo e($index); ?>" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm"></textarea>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="admin-panel admin-form-panel p-6">
                    <p class="admin-section-title"><?php echo e(__('Primary Service Cards')); ?></p>

                    <div class="mt-4 space-y-5">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ($translationPayload['primary_pillars'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cardIndex => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Card')); ?> #<?php echo e($cardIndex + 1); ?></p>

                                <div class="mt-3 grid gap-3 md:grid-cols-2">
                                    <div>
                                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Title')); ?></label>
                                        <input type="text" wire:model="form.translation_payload.primary_pillars.<?php echo e($cardIndex); ?>.title" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                                    </div>
                                    <div>
                                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('URL')); ?></label>
                                        <input type="text" wire:model="form.translation_payload.primary_pillars.<?php echo e($cardIndex); ?>.url" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                                    </div>
                                </div>

                                <div class="mt-3">
                                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Text')); ?></label>
                                    <textarea rows="4" wire:model="form.translation_payload.primary_pillars.<?php echo e($cardIndex); ?>.text" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm"></textarea>
                                </div>

                                <div class="mt-3">
                                    <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Action Label')); ?></label>
                                    <input type="text" wire:model="form.translation_payload.primary_pillars.<?php echo e($cardIndex); ?>.action_label" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm md:max-w-sm" />
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            <?php elseif($isFinanceTemplate): ?>
                <div class="admin-panel admin-form-panel p-6">
            ...
            <?php elseif($isAuditTemplate): ?>
                ...
                <div class="grid gap-6 xl:grid-cols-2">
                    ...
                    <?php echo $__env->make('livewire.admin.content.service.partials.meeting-cta-editor', [
            ...
            <?php elseif($isAccountingTemplate): ?>
                <div class="admin-panel admin-form-panel p-6">
                    ...
                    <p class="mt-4 text-sm text-slate-600">
                        <?php echo e(__('Računovodstvo sada koristi puni landing template s overview blokom, editorial sekcijom, 7 detaljnih service sekcija, video blokom, kontaktom i blogom. Ovdje uređujete sav tekstualni sadržaj tih blokova.')); ?>
                ...
                <div class="grid gap-6 xl:grid-cols-2">
                    <div id="accounting-intro-admin" class="admin-panel admin-form-panel p-6 scroll-mt-24">
                        ...
                        <div class="mt-4 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
                            <?php echo e(__('Popis usluga u overview bloku automatski povlači naslove iz sekcija 1-7 niže u editoru.')); ?>
                    ...
                    <div id="accounting-editorial-admin" class="admin-panel admin-form-panel p-6 scroll-mt-24 xl:col-span-2">
                        <p class="admin-section-title"><?php echo e(__('Editorial Block')); ?></p>
                        ...
                        <div class="mt-6 grid gap-4 xl:grid-cols-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ($translationPayload['editorial_section']['cards'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cardIndex => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                    <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Card')); ?> #<?php echo e($cardIndex + 1); ?></p>

                                    <div class="mt-3">
                                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Title')); ?></label>
                                        <input type="text" wire:model="form.translation_payload.editorial_section.cards.<?php echo e($cardIndex); ?>.title" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                                    </div>

                                    <div class="mt-3">
                                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Body')); ?></label>
                                        <textarea rows="6" wire:model="form.translation_payload.editorial_section.cards.<?php echo e($cardIndex); ?>.body" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm"></textarea>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    ...
                    <div id="accounting-details-admin" class="admin-panel admin-form-panel p-6 scroll-mt-24 xl:col-span-2">
                        <p class="admin-section-title"><?php echo e(__('Service Sections 1-7')); ?></p>
                        <p class="mt-2 text-sm text-slate-500"><?php echo e(__('Naslovi ovih sekcija automatski pune gornji popis Usluge računovodstva na stranici.')); ?></p>

                        <div class="mt-6 space-y-5">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ($translationPayload['detail_sections'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionIndex => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                    <div class="flex flex-wrap items-center justify-between gap-3">
                                        <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Section')); ?> #<?php echo e($sectionIndex + 1); ?></p>
                                        <span class="rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-semibold text-slate-500"><?php echo e($section['slug'] ?? ('section-'.$sectionIndex)); ?></span>
                                    </div>

                                    <div class="mt-4 grid gap-3 md:grid-cols-2">
                                        <div>
                                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Title')); ?></label>
                                            <input type="text" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.title" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                                        </div>
                                        <div>
                                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('List Title')); ?></label>
                                            <input type="text" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.list_title" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                                        </div>
                                    </div>

                                    <div class="mt-3">
                                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Intro')); ?></label>
                                        <textarea rows="4" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.intro" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm"></textarea>
                                    </div>

                                    <div class="mt-5">
                                        <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('List Items')); ?></p>
                                        <div class="mt-3 space-y-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ($section['items'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemIndex => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div>
                                                    <div class="mb-1 flex items-center justify-between gap-3">
                                                        <label class="block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Item')); ?> #<?php echo e($itemIndex + 1); ?></label>
                                                        <button type="button" wire:click="removeTranslationListItem('detail_sections.<?php echo e($sectionIndex); ?>.items', <?php echo e($itemIndex); ?>)" class="text-xs font-semibold text-rose-600 hover:text-rose-700"><?php echo e(__('Remove')); ?></button>
                                                    </div>
                                                    <textarea rows="3" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.items.<?php echo e($itemIndex); ?>" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm"></textarea>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>

                                        <div class="mt-3">
                                            <button type="button" wire:click="addTranslationListItem('detail_sections.<?php echo e($sectionIndex); ?>.items')" class="rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100">
                                                <?php echo e(__('Add Item')); ?>
                                    ...
                                    <div class="mt-5">
                                        <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('After List Paragraphs')); ?></p>
                                        <div class="mt-3 space-y-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ($section['after_list'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paragraphIndex => $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div>
                                                    <div class="mb-1 flex items-center justify-between gap-3">
                                                        ...
                                                        <button type="button" wire:click="removeTranslationListItem('detail_sections.<?php echo e($sectionIndex); ?>.after_list', <?php echo e($paragraphIndex); ?>)" class="text-xs font-semibold text-rose-600 hover:text-rose-700"><?php echo e(__('Remove')); ?></button>
                                                    </div>
                                                    <textarea rows="4" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.after_list.<?php echo e($paragraphIndex); ?>" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm"></textarea>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>

                                        <div class="mt-3">
                                            <button type="button" wire:click="addTranslationListItem('detail_sections.<?php echo e($sectionIndex); ?>.after_list')" class="rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100">
                                                <?php echo e(__('Add Paragraph')); ?>
                                    ...
                                    <div class="mt-5">
                                        <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Downloads')); ?></p>
                                        <div class="mt-3 space-y-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ($section['downloads'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $downloadIndex => $download): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="rounded-xl border border-slate-200 bg-white p-3">
                                                    <div class="grid gap-3 lg:grid-cols-[1fr_1.2fr_180px_auto] lg:items-end">
                                                        <div>
                                                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Title')); ?></label>
                                                            <input type="text" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.downloads.<?php echo e($downloadIndex); ?>.title" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                                                        </div>
                                                        <div>
                                                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('URL')); ?></label>
                                                            <input type="text" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.downloads.<?php echo e($downloadIndex); ?>.url" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                                                        </div>
                                                        <div>
                                                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Button Label')); ?></label>
                                                            <input type="text" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.downloads.<?php echo e($downloadIndex); ?>.label" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                                                        </div>
                                                        <div class="flex justify-end">
                                                            <button type="button" wire:click="removeTranslationListItem('detail_sections.<?php echo e($sectionIndex); ?>.downloads', <?php echo e($downloadIndex); ?>)" class="rounded-lg border border-rose-200 px-3 py-2 text-xs font-semibold text-rose-700 hover:bg-rose-50"><?php echo e(__('Remove')); ?></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div class="mt-3">
                                            <button type="button" wire:click="addTranslationListItem('detail_sections.<?php echo e($sectionIndex); ?>.downloads', 'download_item')" class="rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100">
                                                <?php echo e(__('Add Download')); ?>
                                    ...
                                    <div class="mt-5">
                                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Quote')); ?></label>
                                        <textarea rows="3" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.quote" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm"></textarea>
                                    </div>

                                    <div class="mt-4">
                                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('CTA Text')); ?></label>
                                        <textarea rows="2" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.cta_text" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm"></textarea>
                                    </div>

                                    <div class="mt-3 grid gap-3 md:grid-cols-2">
                                        <div>
                                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('CTA Label')); ?></label>
                                            <input type="text" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.cta_label" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                                        </div>
                                        <div>
                                            <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('CTA URL')); ?></label>
                                            <input type="text" wire:model="form.translation_payload.detail_sections.<?php echo e($sectionIndex); ?>.cta_url" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div id="accounting-videos-admin" class="admin-panel admin-form-panel p-6 scroll-mt-24">
                        <p class="admin-section-title"><?php echo e(__('Video Block')); ?></p>
                        ...
                        <div class="mt-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['form.translation_payload.video_section.title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-rose-600"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mt-3">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['form.translation_payload.video_section.intro'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-rose-600"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mt-4 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
                            <?php echo e(__('Same video list and YouTube source links are managed under the Sources tab.')); ?>
            ...
            <?php elseif($isAdvisoryTemplate): ?>
                <?php echo $__env->make('livewire.admin.content.service.partials.advisory-editor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'sources' && $templateSupportsSources): ?>
            ...
            <div class="grid gap-6 xl:grid-cols-2">
                <div class="admin-panel admin-form-panel p-6">
                    ...
                    <p class="mt-2 text-sm text-slate-500"><?php echo e(__('Unesi naslov videa i YouTube link. Redoslijed ovdje je isti kao na stranici, a block se prikazuje prije kontakt forme ako postoji barem jedan video.')); ?></p>

                    <div class="mt-4 space-y-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = (array) ($pagePayload['video_source']['items'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div wire:key="service-video-row-<?php echo e($index); ?>" class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                <div class="grid gap-3 md:grid-cols-[1fr_1.2fr_auto] md:items-start">
                                    <div>
                                        ...
                                        <input type="text" wire:model="form.page_payload.video_source.items.<?php echo e($index); ?>.title" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['form.page_payload.video_source.items.'.$index.'.title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-rose-600"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div>
                                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('YouTube URL')); ?></label>
                                        <input type="text" wire:model="form.page_payload.video_source.items.<?php echo e($index); ?>.youtube_url" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" placeholder="https://www.youtube.com/watch?v=..." />
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['form.page_payload.video_source.items.'.$index.'.youtube_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-rose-600"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="flex flex-wrap gap-2 md:justify-end">
                                        <button type="button" wire:click="moveVideoSourceUp(<?php echo e($index); ?>)" class="rounded-lg border border-slate-300 px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100"><?php echo e(__('Up')); ?></button>
                                        <button type="button" wire:click="moveVideoSourceDown(<?php echo e($index); ?>)" class="rounded-lg border border-slate-300 px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100"><?php echo e(__('Down')); ?></button>
                                        <button type="button" wire:click="removeVideoSource(<?php echo e($index); ?>)" class="rounded-lg border border-rose-200 px-3 py-2 text-xs font-semibold text-rose-700 hover:bg-rose-50"><?php echo e(__('Remove')); ?></button>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="admin-panel admin-form-panel p-6">
                    ...
                    <div class="mt-4">
                        <label class="mb-1 block text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('Section Title')); ?></label>
                        <input type="text" wire:model="form.translation_payload.video_section.title" class="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm" />
                        <p class="mt-1 text-xs text-slate-500"><?php echo e(__('Ako ostane prazno, frontend prikazuje samo videe bez naslova.')); ?></p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['form.translation_payload.video_section.title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
