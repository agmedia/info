...
<section class="rounded-2xl border border-slate-200 bg-slate-900 px-6 py-7 text-white">
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            <h2 class="text-xl font-semibold"><?php echo e($translation->title ?? $block->name); ?></h2>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($translation?->subtitle)): ?>
                <p class="mt-2 text-sm text-slate-300"><?php echo e($translation->subtitle); ?></p>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ctaLabel !== '' && $ctaUrl !== ''): ?>
            <a href="<?php echo e($ctaUrl); ?>" class="front-link-cta inline-flex rounded-xl bg-white px-4 py-2 text-sm font-semibold text-slate-900 hover:bg-slate-100">
                <?php echo e($ctaLabel); ?>
...
<?php /**PATH /Users/tomek/Herd/info/resources/views/front/content-blocks/types/cta_banner.blade.php ENDPATH**/ ?>