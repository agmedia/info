...
<section class="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-white py-8">
    <div class="w-full px-4 sm:px-6 lg:px-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($posts->isNotEmpty()): ?>
            ...
            <?php if (! $__env->hasRenderedOnce('b60a4b4e-606d-4051-8be9-45a7bb97dd1f')): $__env->markAsRenderedOnce('b60a4b4e-606d-4051-8be9-45a7bb97dd1f'); ?>
            ...
            <?php if (! $__env->hasRenderedOnce('3ced2cbe-91e6-455a-a3c8-fa89d3fedbe1')): $__env->markAsRenderedOnce('3ced2cbe-91e6-455a-a3c8-fa89d3fedbe1'); ?>
                <?php $__env->startPush('scripts'); ?>
                    <script>
                        (function () {
                            const init = function () {
