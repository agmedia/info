...
<section class="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-white py-8">
    <div class="w-full px-4 sm:px-6 lg:px-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($posts->isNotEmpty()): ?>
            ...
            <?php if (! $__env->hasRenderedOnce('dcb3dff3-6128-4982-ab86-3738d52972df')): $__env->markAsRenderedOnce('dcb3dff3-6128-4982-ab86-3738d52972df'); ?>
            ...
            <?php if (! $__env->hasRenderedOnce('5545097f-d22d-47e0-8451-114cf2817285')): $__env->markAsRenderedOnce('5545097f-d22d-47e0-8451-114cf2817285'); ?>
                <?php $__env->startPush('scripts'); ?>
                    <script>
                        (function () {
                            const init = function () {
