<div class="space-y-6">
    <div class="admin-panel admin-search-panel p-6">
        <div class="flex items-end justify-between gap-4">
            <div>
                <h1 class="text-xl font-semibold tracking-tight"><?php echo e(__('admin.messages.career.manager.title')); ?></h1>
                <p class="mt-1 text-sm text-slate-600"><?php echo e(__('admin.messages.career.manager.subtitle')); ?></p>
                <p class="mt-2 text-xs text-slate-500"><?php echo e(__('admin.messages.career.manager.items_per_page')); ?>: <span class="admin-chip"><?php echo e($perPage); ?></span></p>
            </div>
                ...
                <div class="grid w-full max-w-[48rem] items-end gap-3 md:grid-cols-[minmax(0,1fr)_12rem]">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="<?php echo e(__('admin.messages.career.manager.search_placeholder')); ?>"
    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <div class="admin-panel admin-panel-soft p-4">
            <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('admin.messages.career.manager.summary.all')); ?></p>
            <p class="mt-2 text-2xl font-semibold text-slate-900"><?php echo e(number_format((int) ($totals['all'] ?? 0))); ?></p>
        </div>
        <div class="admin-panel admin-panel-soft p-4">
            <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('admin.messages.career.status.new')); ?></p>
            <p class="mt-2 text-2xl font-semibold text-amber-700"><?php echo e(number_format((int) ($totals['new'] ?? 0))); ?></p>
        </div>
        <div class="admin-panel admin-panel-soft p-4">
            <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('admin.messages.career.status.read')); ?></p>
            <p class="mt-2 text-2xl font-semibold text-sky-700"><?php echo e(number_format((int) ($totals['read'] ?? 0))); ?></p>
        </div>
        <div class="admin-panel admin-panel-soft p-4">
            <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500"><?php echo e(__('admin.messages.career.status.resolved')); ?></p>
        ...
        <div class="mt-4 overflow-x-auto">
            <table class="admin-items-table min-w-full text-sm">
                <thead class="text-slate-600">
                    <tr>
                        <th class="px-3 py-2 text-left font-semibold"><?php echo e(__('admin.messages.career.manager.table.candidate')); ?></th>
                        <th class="px-3 py-2 text-left font-semibold"><?php echo e(__('admin.messages.career.manager.table.message')); ?></th>
                        <th class="px-3 py-2 text-left font-semibold"><?php echo e(__('admin.messages.career.manager.table.document')); ?></th>
                        <th class="px-3 py-2 text-center font-semibold"><?php echo e(__('admin.messages.career.manager.table.state')); ?></th>
                        <th class="px-3 py-2 text-center font-semibold"><?php echo e(__('admin.messages.career.manager.table.received')); ?></th>
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="<?php echo e($row->status === 'new' ? 'bg-amber-50/40' : ''); ?>">
                            ...
                            <td class="px-3 py-3 text-slate-700">
                                <?php echo e(\Illuminate\Support\Str::limit(trim((string) ($row->message ?? '')) !== '' ? (string) $row->message : __('admin.messages.career.manager.no_message'), 180)); ?>

                            </td>
                            <td class="px-3 py-3 text-slate-700">
                                <div class="font-medium text-slate-900"><?php echo e($row->cv_original_name); ?></div>
                                <div class="mt-1 text-xs text-slate-500"><?php echo e($row->cv_size_human); ?></div>
                                <a href="<?php echo e(route('admin.messages.career.download', ['careerApplication' => $row->id])); ?>" class="mt-3 inline-flex rounded-lg border border-slate-300 px-2 py-1 text-xs font-semibold text-slate-700 hover:bg-slate-100">
                                    <?php echo e(__('admin.messages.career.manager.download')); ?>

                                </a>
                            </td>
                            <td class="px-3 py-3 text-center">
                                <span class="rounded-full px-2.5 py-1 text-xs font-semibold <?php echo e($statusClasses); ?>">
                                    <?php echo e(__('admin.messages.career.status.'.$row->status)); ?>
                            ...
                            <td class="px-3 py-3 text-center text-xs text-slate-600">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row->reviewed_at): ?>
                                    <div class="mt-1 text-[11px] text-slate-500">
                                        <?php echo e(__('admin.messages.career.manager.reviewed_by', ['name' => $row->reviewer?->name ?: __('admin.layout.admin')])); ?>
                            ...
                            <td class="px-3 py-3">
                                <div class="flex flex-wrap justify-end gap-2">
                                    ...
                                    >
                                        <?php echo e(__('admin.messages.career.manager.actions.mark_new')); ?>
                                    ...
                                    >
                                        <?php echo e(__('admin.messages.career.manager.actions.mark_read')); ?>
                                    ...
                                    >
                                        <?php echo e(__('admin.messages.career.manager.actions.mark_resolved')); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="6" class="px-3 py-8 text-center text-sm text-slate-500"><?php echo e(__('admin.messages.career.manager.empty')); ?></td>
                        </tr>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </tbody>
            </table>
...
</div><?php /**PATH /Users/tomek/Herd/info/resources/views/livewire/admin/message/career-application-manager.blade.php ENDPATH**/ ?>