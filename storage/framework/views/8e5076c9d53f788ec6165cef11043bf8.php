...
<section class="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-white py-8">
    <div class="w-full pt-5 px-4 sm:px-6 lg:px-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reviewRows->isNotEmpty()): ?>
            ...
            <?php if (! $__env->hasRenderedOnce('58d3c099-4325-4eb0-a02e-0b0f63815133')): $__env->markAsRenderedOnce('58d3c099-4325-4eb0-a02e-0b0f63815133'); ?>
            ...
            <?php if (! $__env->hasRenderedOnce('cda3e7c2-ed88-4124-a037-f9577dac9a60')): $__env->markAsRenderedOnce('cda3e7c2-ed88-4124-a037-f9577dac9a60'); ?>
                <?php $__env->startPush('scripts'); ?>
                    <script>
                        (function () {
                            const init = function () {
