...
<section class="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-white py-8">
    <div class="w-full pt-5 px-4 sm:px-6 lg:px-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reviewRows->isNotEmpty()): ?>
            ...
            <?php if (! $__env->hasRenderedOnce('532e37d4-e6f2-4b56-a929-5c8e290417d2')): $__env->markAsRenderedOnce('532e37d4-e6f2-4b56-a929-5c8e290417d2'); ?>
            ...
            <?php if (! $__env->hasRenderedOnce('18d9a196-bbbd-4950-aab6-ecb35d132827')): $__env->markAsRenderedOnce('18d9a196-bbbd-4950-aab6-ecb35d132827'); ?>
                <?php $__env->startPush('scripts'); ?>
                    <script>
                        (function () {
                            const init = function () {
...
<?php /**PATH /Users/tomek/Herd/info/resources/views/front/content-blocks/instances/comments.blade.php ENDPATH**/ ?>