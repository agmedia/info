...
<section class="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-white py-8">
    <div class="w-full pt-5 px-4 sm:px-6 lg:px-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reviewRows->isNotEmpty()): ?>
            ...
            <?php if (! $__env->hasRenderedOnce('49536b86-5581-48ac-9698-c98c154b286b')): $__env->markAsRenderedOnce('49536b86-5581-48ac-9698-c98c154b286b'); ?>
            ...
            <?php if (! $__env->hasRenderedOnce('0eaf78dc-fa83-4284-ba66-75b7947e0b67')): $__env->markAsRenderedOnce('0eaf78dc-fa83-4284-ba66-75b7947e0b67'); ?>
                <?php $__env->startPush('scripts'); ?>
                    <script>
                        (function () {
                            const init = function () {
