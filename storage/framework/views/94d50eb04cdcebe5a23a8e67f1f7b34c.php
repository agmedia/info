...
<?php $__env->startSection('content'); ?>
        ...
        <section id="usluge" class="ac-services-modern">
            ...
            <div class="ac-services-grid">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $serviceCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article id="<?php echo e($card['anchor']); ?>" class="ac-service-item <?php echo e($card['featured'] ? 'is-featured' : ''); ?>">
                        <a href="<?php echo e($card['url'] ?? route('contact.create')); ?>" class="ac-service-card-link" aria-label="Istraži uslugu: <?php echo e($card['title']); ?>">
                            <div class="ac-service-media">
                                <img
                                    ...
                                    decoding="async"
                                >
                                <span class="ac-service-pill"><?php echo e(\Illuminate\Support\Str::upper($card['tag'])); ?></span>
    ...
    <?php if (! $__env->hasRenderedOnce('4ab80dc4-2e5a-4135-8a33-b592582f4ec1')): $__env->markAsRenderedOnce('4ab80dc4-2e5a-4135-8a33-b592582f4ec1'); ?>
        <script>
            (function () {
