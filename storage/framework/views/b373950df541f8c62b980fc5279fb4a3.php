        ...
        <div class="mx-auto w-full max-w-[1320px] px-4 py-10 sm:px-6 lg:px-8">
                ...
                <div class="ac-reference-head-wrap">
                    <div class="ac-services-head ac-support-story-head ac-reference-head">
                        <div class="ac-services-eyebrow">
                            ...
                            <p class="ac-services-kicker"><?php echo e($sectionKicker); ?></p>
                            <span class="ac-services-eyebrow-line" aria-hidden="true"></span>
                        </div>
                ...
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $referenceItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="ac-reference-card group rounded-[28px] border border-slate-200 bg-white px-6 py-7 shadow-[0_20px_50px_-38px_rgba(15,23,42,0.45)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_28px_60px_-38px_rgba(15,23,42,0.55)]">
                            ...
                            <h3 class="mt-5 text-base font-semibold tracking-tight text-slate-900"><?php echo e($item['name']); ?></h3>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($item['caption'] ?? '') !== '' && ($item['caption'] ?? '') !== ($item['name'] ?? '')): ?>
                                <p class="mt-2 text-sm leading-6 text-slate-600"><?php echo e($item['caption']); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </article>
            ...
            <?php else: ?>
                <article class="rounded-[28px] border border-dashed border-slate-300 bg-white px-6 py-10 text-center shadow-[0_20px_50px_-40px_rgba(15,23,42,0.35)]">
                    <p class="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500"><?php echo e(__('Alpha Capitalis')); ?></p>
                    <h2 class="mt-3 text-2xl font-semibold tracking-tight text-slate-900"><?php echo e($emptyStateTitle); ?></h2>
                    <p class="mx-auto mt-3 max-w-2xl text-sm leading-7 text-slate-600"><?php echo e($emptyStateText); ?></p>
                </article>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </section>
