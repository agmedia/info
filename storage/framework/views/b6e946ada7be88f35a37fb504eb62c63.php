...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($serviceVideos->isNotEmpty()): ?>
    <section
        class="ac-service-videos-section ac-support-story ac-home-blog ac-blog-related-section ac-family-blog-section"
        <?php if($serviceVideoSectionTitle !== ''): ?>
            aria-labelledby="ac-service-videos-title"
        <?php else: ?>
            aria-label="<?php echo e(str_starts_with(strtolower($serviceVideosLocale), 'hr') ? 'Video sekcija usluga' : 'Service video section'); ?>"
        <?php endif; ?>
    >
        <div class="mx-auto w-full max-w-[1240px] px-6 lg:px-10">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasServiceVideoHead): ?>
                <div class="ac-support-story-hero">
                    <div class="ac-support-story-shell">
                        <div class="ac-services-head ac-support-story-head">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($serviceVideoSectionTitle !== ''): ?>
                                <h2 id="ac-service-videos-title">
                                    <span><?php echo e($serviceVideoSectionTitle); ?></span>
                                </h2>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($serviceVideoSectionIntro !== ''): ?>
                                <p class="ac-services-intro"><?php echo e($serviceVideoSectionIntro); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="ac-service-videos-carousel<?php echo e($hasServiceVideoHead ? '' : ' ac-service-videos-carousel--flush'); ?>">
                <div class="splide ac-service-videos-splide" data-service-videos-splide>
                    <div class="splide__track">
                        <ul class="splide__list">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $serviceVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <article class="ac-service-video-card">
                                        <div class="ac-service-video-frame" data-service-video-frame>
                                            <iframe
                                                ...
                                                title="<?php echo e(trim((string) ($video['title'] ?? '')) !== '' ? $video['title'] : ($serviceVideoSectionTitle !== '' ? $serviceVideoSectionTitle : 'Video')); ?>"
                                                loading="lazy"
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($video['poster_url'] ?? '')) !== ''): ?>
                                                <button
                                                    ...
                                                    aria-label="<?php echo e($serviceVideoPlayLabel); ?>: <?php echo e(trim((string) ($video['title'] ?? '')) !== '' ? $video['title'] : ($serviceVideoSectionTitle !== '' ? $serviceVideoSectionTitle : 'Video')); ?>"
                                                >
