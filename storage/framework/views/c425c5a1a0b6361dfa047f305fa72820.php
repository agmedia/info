<?php
    ...
    $audienceIcons = [
        'founders' => [
            ...
            'href' => asset('front-theme/fonts/sprites/solid.svg#house'),
        ],
        'successors' => [
            'view_box' => '0 0 576 512',
            'href' => asset('front-theme/fonts/sprites/solid.svg#arrow-trend-up'),
        ],
        'family' => [
            'view_box' => '0 0 640 512',
            'href' => asset('front-theme/fonts/sprites/solid.svg#users'),
        ],
        'managers' => [
            'view_box' => '0 0 512 512',
            'href' => asset('front-theme/fonts/sprites/solid.svg#briefcase'),
        ],
    ];
?>
            ...
            <section id="family-business-publika" class="ac-family-section ac-family-section--intro">
                ...
                <div class="ac-family-foundation-grid">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $audienceSection['cards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $audienceIcon = $audienceIcons[$card['icon'] ?? 'managers'] ?? $audienceIcons['managers'];
                        ?>
                        <article class="ac-family-foundation-item">
                            <div class="ac-family-foundation-item-head">
                                <span class="ac-family-foundation-icon" aria-hidden="true">
                                    <svg viewBox="<?php echo e($audienceIcon['view_box']); ?>" fill="currentColor">
                                        <use href="<?php echo e($audienceIcon['href']); ?>"></use>
                                    </svg>
                                </span>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($brochureUrl): ?>
                        <div class="mt-8 flex justify-center lg:mt-10">
                            <a
                                ...
                                class="ac-family-brochure-button inline-flex min-w-[232px] h-12 items-center justify-center gap-3 whitespace-nowrap border border-white/10 bg-[#0f1b2d] px-6 text-[0.78rem] font-semibold uppercase tracking-[0.16em] !text-white transition hover:bg-[#123250]"
                            >
...
<?php if (! $__env->hasRenderedOnce('0b12de64-1eee-4308-82f0-047c4a91ff77')): $__env->markAsRenderedOnce('0b12de64-1eee-4308-82f0-047c4a91ff77'); ?>
...
<?php if (! $__env->hasRenderedOnce('3bc4e5b7-56bf-4253-af99-5b2132dc6dfb')): $__env->markAsRenderedOnce('3bc4e5b7-56bf-4253-af99-5b2132dc6dfb'); ?>
