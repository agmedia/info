<div class="front-surface-muted mx-auto grid max-w-7xl gap-4 rounded-3xl p-5 text-white md:grid-cols-3 md:p-6">
    <div class="rounded-2xl border border-white/10 bg-white/5 p-4">
        <div class="flex items-center gap-4">
            <div class="flex h-11 w-11 items-center justify-center rounded-full border border-fuchsia-300/40 bg-fuchsia-500/15">
...
<?php /**PATH /Users/tomek/Herd/info/resources/views/front/content-blocks/instances/front-hero-benefits.blade.php ENDPATH**/ ?>