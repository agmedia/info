        ...
        <section class="ac-tool-intro" aria-labelledby="ac-lease-title">
            <div class="ac-tool-container ac-tool-intro-layout">
                <div class="ac-tool-intro-heading">
                    ...
                    <h1 class="values-title services-index-intro-title ac-tool-display-title" id="ac-lease-title" data-words-slide-from-right aria-label="<?php echo e(__('lease_calculator.heading')); ?>">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $leaseHeadingWords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $word): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="values-word animation-index-<?php echo e($loop->index); ?> <?php echo e($loop->last && count($leaseHeadingWords) > 1 ? 'is-accent' : ''); ?>" aria-hidden="true"><?php echo e($word); ?></span>
                ...
                <section class="ac-lease-card content-reveal animation-index-0" data-image-reveal>
                    <div class="ac-lease-card-head">
                        <div class="ac-lease-card-head-copy">
                            ...
                            <h2 id="ac-lease-form-title"><?php echo e(__('lease_calculator.form.title')); ?></h2>
                            <p><?php echo e(__('lease_calculator.form.intro')); ?></p>
                        </div>

                        <p class="ac-lease-card-description"><?php echo e(__('lease_calculator.intro')); ?></p>
                    </div>
                    ...
                    >
                        <div class="ac-lease-rows">
                            <div class="ac-lease-row">
                                ...
                                <div class="ac-lease-row-control">
                                    <div class="ac-lease-date-field" data-lease-date-field="lease-start-date">
                                        <span class="ac-lease-date-display is-placeholder" data-lease-date-display="lease-start-date"><?php echo e(__('lease_calculator.form.date_placeholder')); ?></span>
                            ...
                            <div class="ac-lease-row">
                                ...
                                <div class="ac-lease-row-control">
                                    <div class="ac-lease-date-field" data-lease-date-field="lease-end-date">
                                        <span class="ac-lease-date-display is-placeholder" data-lease-date-display="lease-end-date"><?php echo e(__('lease_calculator.form.date_placeholder')); ?></span>
                            ...
                            <div class="ac-lease-row is-output" data-lease-output-row hidden>
                                ...
                                <div class="ac-lease-row-control">
                                    <output class="ac-lease-output is-placeholder" data-lease-output="months" data-placeholder="<?php echo e(__('lease_calculator.output_placeholders.months')); ?>"><?php echo e(__('lease_calculator.output_placeholders.months')); ?></output>
                                </div>
                            </div>
                            ...
                            <div class="ac-lease-row is-output" data-lease-output-row hidden>
                                ...
                                <div class="ac-lease-row-control">
                                    <output class="ac-lease-output is-placeholder" data-lease-output="total_lease" data-placeholder="<?php echo e(__('lease_calculator.output_placeholders.total_lease')); ?>"><?php echo e(__('lease_calculator.output_placeholders.total_lease')); ?></output>
                                </div>
                            </div>
                            ...
                            <div class="ac-lease-row is-output" data-lease-output-row hidden>
                                ...
                                <div class="ac-lease-row-control">
                                    <output class="ac-lease-output is-placeholder" data-lease-output="initial_liability" data-placeholder="<?php echo e(__('lease_calculator.output_placeholders.initial_liability')); ?>"><?php echo e(__('lease_calculator.output_placeholders.initial_liability')); ?></output>
                                </div>
                            </div>
                            ...
                            <div class="ac-lease-row is-output" data-lease-output-row hidden>
                                ...
                                <div class="ac-lease-row-control">
                                    <output class="ac-lease-output is-placeholder" data-lease-output="monthly_depreciation" data-placeholder="<?php echo e(__('lease_calculator.output_placeholders.monthly_depreciation')); ?>"><?php echo e(__('lease_calculator.output_placeholders.monthly_depreciation')); ?></output>
                                </div>
                            </div>
                            ...
                            <div class="ac-lease-row is-output" data-lease-output-row hidden>
                                ...
                                <div class="ac-lease-row-control">
                                    <output class="ac-lease-output is-placeholder" data-lease-output="interest_total" data-placeholder="<?php echo e(__('lease_calculator.output_placeholders.interest_total')); ?>"><?php echo e(__('lease_calculator.output_placeholders.interest_total')); ?></output>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ac-lease-form-actions">
                            <button type="submit" class="editorial-dark-button">
                                <span><?php echo e(__('lease_calculator.form.calculate')); ?></span>
                            </button>
                            <button type="reset" class="button button-outline ac-lease-reset">
                                <span><?php echo e(__('lease_calculator.form.reset')); ?></span>
                            </button>
                        </div>
                    </form>
                </section>
...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('front-theme/styles/pages/tool-pages.css')); ?>?v=<?php echo e(filemtime(public_path('front-theme/styles/pages/tool-pages.css'))); ?>">
<?php $__env->stopPush(); ?>
