...
<section class="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-white py-8">
    <div class="w-full px-4 sm:px-6 lg:px-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reviewRows->isNotEmpty()): ?>
            <style>
                #reviews-carousel-<?php echo e($block->id); ?> .splide__arrow {
                    opacity: 0;
                    width: 46px;
                    height: 46px;
                ...
                #reviews-carousel-<?php echo e($block->id); ?>:hover .splide__arrow,
                #reviews-carousel-<?php echo e($block->id); ?>:focus-within .splide__arrow {
                    opacity: 1;
                    transform: translateY(-50%) scale(1);
                }

                #reviews-carousel-<?php echo e($block->id); ?> .splide__arrow:hover {
                    background: rgba(15, 23, 42, 0.55);
                }

                #reviews-carousel-<?php echo e($block->id); ?> .splide__arrow svg {
                    fill: #fff;
                }

                #reviews-carousel-<?php echo e($block->id); ?> .review-card {
                    border: 1px solid #dbe3ef;
                    background: linear-gradient(180deg, #ffffff 0%, #f7f9fc 100%);
                }

                #reviews-carousel-<?php echo e($block->id); ?> .review-quote {
                    color: #c9d3e5;
                    font-size: 2rem;
                    line-height: 1;
                    font-weight: 700;
            ...
            <?php if (! $__env->hasRenderedOnce('eda87918-c61a-4f48-ae85-84b8492c7403')): $__env->markAsRenderedOnce('eda87918-c61a-4f48-ae85-84b8492c7403'); ?>
            ...
            <div id="reviews-carousel-<?php echo e($block->id); ?>" class="splide" data-five-star-reviews-splide>
                <div class="splide__track">
                    <ul class="splide__list">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $reviewRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="splide__slide">
                                ...
                                <article class="review-card h-full p-6">
                                    ...
                                    <p class="mt-3 line-clamp-4 text-sm leading-relaxed text-slate-700"><?php echo e($row->body); ?></p>
                                    <div class="mt-5 flex items-center gap-3 border-t border-slate-200 pt-3">
                                        <span class="inline-flex h-8 w-8 items-center justify-center border border-slate-300 bg-white text-xs font-bold uppercase text-slate-700"><?php echo e($authorInitial); ?></span>
                                        <p class="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500"><?php echo e($author); ?></p>
                                    </div>
                                </article>
                            </li>
            ...
            <?php if (! $__env->hasRenderedOnce('1eb9c4a1-3525-419c-bfe5-945be790fc37')): $__env->markAsRenderedOnce('1eb9c4a1-3525-419c-bfe5-945be790fc37'); ?>
                <?php $__env->startPush('scripts'); ?>
                    <script>
                        (function () {
                            const init = function () {
...
<?php /**PATH /Users/tomek/Herd/info/resources/views/front/content-blocks/types/five_star_reviews_carousel.blade.php ENDPATH**/ ?>