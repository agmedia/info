...
<section class="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-white py-8">
    <div class="w-full px-4 sm:px-6 lg:px-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reviewRows->isNotEmpty()): ?>
            ...
            <?php if (! $__env->hasRenderedOnce('e84eb59a-7a1c-4080-96d7-5626be4d3208')): $__env->markAsRenderedOnce('e84eb59a-7a1c-4080-96d7-5626be4d3208'); ?>
            ...
            <?php if (! $__env->hasRenderedOnce('1813db33-3e24-4912-aaef-2643b9dc3582')): $__env->markAsRenderedOnce('1813db33-3e24-4912-aaef-2643b9dc3582'); ?>
                <?php $__env->startPush('scripts'); ?>
                    <script>
                        (function () {
                            const init = function () {
