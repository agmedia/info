...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slides->isNotEmpty()): ?>
    <?php if (! $__env->hasRenderedOnce('064f00a3-33b6-4732-b727-ae61e00b06ba')): $__env->markAsRenderedOnce('064f00a3-33b6-4732-b727-ae61e00b06ba'); ?>
    ...
    <?php if (! $__env->hasRenderedOnce('4a312f54-c5df-475c-b506-c5430f19adb1')): $__env->markAsRenderedOnce('4a312f54-c5df-475c-b506-c5430f19adb1'); ?>
        <?php $__env->startPush('scripts'); ?>
            <script>
                (function () {
                    const init = function () {
