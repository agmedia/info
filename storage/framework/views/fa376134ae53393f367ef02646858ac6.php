...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slides->isNotEmpty()): ?>
    <?php if (! $__env->hasRenderedOnce('2b21a358-ffb3-4050-b34c-93e2254b2f3f')): $__env->markAsRenderedOnce('2b21a358-ffb3-4050-b34c-93e2254b2f3f'); ?>
    ...
    <?php if (! $__env->hasRenderedOnce('f94db4e1-d688-4424-a770-5c3437ce7d86')): $__env->markAsRenderedOnce('f94db4e1-d688-4424-a770-5c3437ce7d86'); ?>
        <?php $__env->startPush('scripts'); ?>
            <script>
                (function () {
                    const init = function () {
    ...
    <?php endif; ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH /Users/tomek/Herd/info/resources/views/front/content-blocks/types/full_width_image_slider.blade.php ENDPATH**/ ?>