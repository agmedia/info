...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slides->isNotEmpty()): ?>
    <?php if (! $__env->hasRenderedOnce('a02c82e8-391b-484c-ba8d-eaa3cef98f9a')): $__env->markAsRenderedOnce('a02c82e8-391b-484c-ba8d-eaa3cef98f9a'); ?>
    ...
    <?php if (! $__env->hasRenderedOnce('db8a28a0-a3b8-46c1-8502-5347807361bd')): $__env->markAsRenderedOnce('db8a28a0-a3b8-46c1-8502-5347807361bd'); ?>
        <?php $__env->startPush('scripts'); ?>
            <script>
                (function () {
                    const init = function () {
